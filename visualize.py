...
visualize_diff_timeline(pd.read_csv(r"C:\Users\yinl3\Documents\Programming\CSCI-2960-RCOS\CSSAW\Dam-Level-Data-Scraper\dam_data\normalized\norm_all_dam_levels.csv", sep=','))